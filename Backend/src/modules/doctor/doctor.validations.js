...
const createDoctorValidation = [
  ...
  check('experience', 'Experience is required and must be a number')
    .not()
    .isEmpty()
    .isNumeric(),
  check('education', 'Education must be a string').optional().isString(),
  check('roomFloor', 'Room/Floor must be a string').optional().isString(),
  check('consultationFee', 'Consultation fee is required and must be a number')
    .not()
    .isEmpty()
    .isNumeric(),
